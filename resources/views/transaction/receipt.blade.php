...
<head>
    ...
    <style>
        /* Aggressive reset for html and body */
        html {
            margin: 0;
            padding: 0;
        }
        ...
        body {
            ...
            font-size: 9px;
            width: 30mm; /* Narrower width for tighter layout */
            margin: 0; /* Align to left on screen */
            padding: 0; /* Remove all padding */
            color: #000;
            box-sizing: border-box;
        }
        
        /* Reset all margins and paddings for tight left alignment */
        * {
...
<body onload="window.print()">
    ...
    <div class="header">
        <h3>DISTRICT 19 GAMING</h3>
        <p>JL. GATOT SUBROTO NO 37, BANYURIP ALIT, PEKALONGAN SELATAN, KOTA PEKALONGAN</p>
    </div>
