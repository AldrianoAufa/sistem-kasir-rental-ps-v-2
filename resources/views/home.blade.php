    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if($todayRevenuePerUser->count() > 0)
                ...
                @else
                    <div class="text-center mb-3">
                        <h4 class="text-warning">Total Pendapatan Hari Ini</h4>
                        <p class="text-muted">Belum ada pendapatan hari ini</p>
                    </div>
                @endif
                ...
                @if(isset($todayRevenuePerUser) && $todayRevenuePerUser->count() > 0)
                    <div class="revenue-per-user-details mb-4">
                        <h6 class="text-muted mb-3 font-weight-bold">Pendapatan Per User:</h6>
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <small class="text-muted d-block">
                                        {{ $userRevenue->role === 'admin' ? 'Admin (Kasir)' : 'Owner (Pemilik)' }}
                                        @if($userRevenue->role === 'admin' && $userRevenue->work_shift_id)
                                            @php
